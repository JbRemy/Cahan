...
![alt text](https://github.com/JbRemy/Cahan/blob/master/figures/HAN.png) 
...
<center>HAN (left) vs CAHAN (right) on an example extracted from the Yelp dataset.</center>

![alt text](https://github.com/JbRemy/Cahan/blob/master/figures/amazon_baseline_cropped.png) | ![alt text](https://github.com/JbRemy/Cahan/blob/master/figures/amazon_sum_bidir_cropped.png)
<center>HAN (left) vs CAHAN (right) on a motivational example.</center>
